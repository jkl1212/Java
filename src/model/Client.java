...
public class Client {
	...
	// constructor
	public Client() {}
	public Client(String clientName, int clientAge, String clientEmail, String clientContact, String clientID,
				   String clientPWD, String clientADR, char clientGender, int clientBday, int clientTO,
				   int clientTOV, float clientAOV, int clientBarcodePayback, String clientGrade, String clientType,
				   char clientRude, int clientLOD, int clientFOD) {
		super();
		...
		this.clientTOV = clientTOV;
		this.clientAOV = clientAOV;
		this.clientBarcodePayback = clientBarcodePayback;
		this.clientGrade = clientGrade;
		this.clientType = clientType;
		
		this.clientRude = clientRude;
		this.clientLOD = clientLOD;
		this.clientFOD = clientFOD;
	}
	...
	public String toString() {
		...
		builder.append(clientBday);
		builder.append("\n");
		
		builder.append("총 주문 회수 : ");
		builder.append(clientTO);
		builder.append("\n");
		
		builder.append("총 주문 금액 : ");
		builder.append(clientTOV);
		builder.append("\n");
		
		builder.append("평균 구매 금액 : ");
		builder.append(clientAOV);
		builder.append("\n");
		
		builder.append("바코드 결제 사용 회수 : ");
		builder.append(clientBarcodePayback);
		builder.append("\n");
		...
		builder.append("고객 분류 : ");
		builder.append(clientType);
		builder.append("\n");
		
		builder.append("블랙리스트 여부 : ");
		builder.append(clientRude);
		builder.append("\n");
		
		builder.append("마지막 주문일 : ");
		builder.append(clientLOD);
		builder.append("\n");
		
		builder.append("첫 주문일 : ");
		builder.append(clientFOD);
		builder.append("\n");
